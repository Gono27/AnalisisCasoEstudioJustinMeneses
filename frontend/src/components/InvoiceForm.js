    ...
    <form onSubmit={handleSubmit}>
      ...
      {productos.map((producto, index) => (
        <div key={index}>
          ...
          <input type="number" name="cantidad" value={producto.cantidad} onChange={(e) => handleProductoChange(index, e)} required />
          <label>Precio:</label>
          <input type="number" name="precio" value={producto.precio} onChange={(e) => handleProductoChange(index, e)} required />
        </div>
      ))}
